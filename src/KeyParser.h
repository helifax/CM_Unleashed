...
static EnumName_t<const char *, int> VKMappings[] = {
    ...
    // XBOX STUFF
    { "XINPUT_GAMEPAD_DPAD_UP", 0xFFF1 },
    { "XINPUT_GAMEPAD_DPAD_DOWN", 0xFFF2 },
    { "XINPUT_GAMEPAD_DPAD_LEFT", 0xFFF4 },
    { "XINPUT_GAMEPAD_DPAD_RIGHT", 0xFFF8 },
    { "XINPUT_GAMEPAD_START", 0xFF1F },
    { "XINPUT_GAMEPAD_BACK", 0xFF2F },
    { "XINPUT_GAMEPAD_LEFT_THUMB", 0xFF4F },
    { "XINPUT_GAMEPAD_RIGHT_THUMB", 0xFF8F },
    { "XINPUT_GAMEPAD_LEFT_SHOULDER", 0xF1FF },
    { "XINPUT_GAMEPAD_RIGHT_SHOULDER", 0xF2FF },
    { "XINPUT_GAMEPAD_A", 0x1FFF },
    { "XINPUT_GAMEPAD_B", 0x2FFF },
    { "XINPUT_GAMEPAD_X", 0x4FFF },
    { "XINPUT_GAMEPAD_Y", 0x8FFF },
